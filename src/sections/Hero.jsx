...
const PhoneContact = () => {
  ...
  const phoneNumber = '+919442173548'
  ...
  return (
    <div className="phone-contact-wrapper hero-phone-contact" ref={wrapperRef}>
      <button
        className="secondary-button phone-contact-hero-button"
    ...
    <div className="hero-glass">
      <div className="hero-text">
        ...
        <p className="section-description hero-lede">
          ...
          <em>short films, music videos, pilots, commercials, and weddings</em>, merging
