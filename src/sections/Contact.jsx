...
const PhoneContact = () => {
  ...
  const displayNumber = '+91 94421 73548'
  ...
  return (
    <div className="phone-contact-wrapper" ref={wrapperRef}>
      <button
        className="phone-contact-button"
        onClick={() => setShowOptions(!showOptions)}
        aria-expanded={showOptions}
        aria-label="Show phone contact options"
      >
        {displayNumber}
      </button>
      {showOptions && (
