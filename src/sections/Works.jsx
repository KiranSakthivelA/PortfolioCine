...
const works = [
  {
    ...
    title: 'Neeralaigal',
    role: 'Music Video',
    url: 'https://youtu.be/WFnhz5Vf70o?si=XI9BHoNgjeU75DYu',
    zoomed: true,
  },
  {
    id: 'k3ajRQyjj1I',
    title: 'Shape Your Future with SRIT 2026',
    role: 'Commercial',
    url: 'https://youtu.be/k3ajRQyjj1I?si=fVzd2B96VSgG9QUN',
  },
  {
    id: 'Qms-LQLbTBk',
...
const Works = () => (
  ...
  >
    <div className="works-carousel">
      {works.map((work) => (
        <article key={work.id} className={`work-card ${work.zoomed ? 'zoomed-thumbnail' : ''}`}>
